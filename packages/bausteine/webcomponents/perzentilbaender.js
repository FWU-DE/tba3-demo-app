...
function aufbauen(wurzel, zustand, el) {
  ...
  svg.append(
    ...
    s('line', {
      ...
      stroke: 'var(--tba3-_farbe-linie)', 'stroke-width': 1,
    }),
    ...
    if (zeile.hatWert) {
      gruppe.append(
        s('path', {
          ...
          stroke: 'var(--tba3-_farbe-text-invers)', 'stroke-width': 0.8,
        }),
  ...
  const eintrag = (x, farbe, text, alsRaute = false) =>
    s('g', { transform: `translate(${x}, 0)` }, [
      alsRaute
        ? s('path', { d: raute(6, 0), fill: MARKER, stroke: 'var(--tba3-_farbe-text-invers)', 'stroke-width': 0.8 })
        : s('rect', { x: 0, y: -5, width: 12, height: 10, rx: 2, fill: farbe }),
      s('text', {
        x: alsRaute ? 15 : 16, y: 4, 'font-size': 10,
        fill: 'var(--tba3-_farbe-text-gedaempft)', text,
      }),
    ]);
  ...
  svg.append(
    ...
    s('text', {
      ...
      fill: 'var(--tba3-_farbe-text-gedaempft)', text: g.xAxisLabel,
    }),
  );
